...
if (isset($_POST['submit'])) {
  ...
  $status = 0;
  $vhid = $_GET['vhid'];
  $sql = "INSERT INTO  vehiclebooking(userEmail,vehicleid,message,Status) VALUES(:useremail,:vehicleid,:message,:status)";
            ...
            <aside class="col-md-3">
              ...
              <div class="sidebar_widget">
                <div class="widget_heading">
                  <h5><i class="fa fa-envelope" aria-hidden="true"></i>Purchase Vehicle</h5>
                </div>
                <form method="post">
